...
function prepareBuildingAndCarCounter() {
    ...
    $('#scriptAmount').append('<div class="col-sm-4 overview_outer"><div class="sidebar-nav"><div class="panel panel-default"><div class="panel-heading">Wachen und Gebäude</div><div class="panel-body" id="scriptBuildingAmount"></div></div></div></div>');
    $('#scriptAmount').append('<div class="col-sm-4 overview_outer"><div class="sidebar-nav"><div class="panel panel-default"><div class="panel-heading">Fahrzeuge</div><div class="panel-body" id="scriptCarAmount"></div></div></div></div>');
}
...
function tabsForMissions() {
    var missionList = $('#mission_list').html(),
        missionListKrankentransporte = $('#mission_list_krankentransporte').html(),
        missionListAlliance = $('#mission_list_alliance').html();
    ...
    $('#scriptMissionTab').append('<div id="scriptMissionMenu"><br /><ul class="nav nav-tabs"><li class="active"><a href="#scriptEmergencies" data-toggle="tab">NF (<span id="scriptEmergencyCounter"></span>)</a></li><li><a href="#scriptTransports" data-toggle="tab">KTP (<span id="scriptTransportCounter"></span>)</a></li><li><a href="#scriptAlliances" data-toggle="tab">VE (<span id="scriptAllianceCounter"></span>)</a></li></ul><br /></div>');
...
function countPatients() {
    var patientsAmount = 0, // Patienten gesamt
        patientsTreatment = 0, // Patienten in Behandlung
        patientsReady = 0; // Patienten transportbereit
